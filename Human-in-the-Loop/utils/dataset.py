...
class CUBDataset(Dataset):
    ...
    def get_concepts_subset(self, concept_ids: list, instance_per_concept: int, random_seed: int): # -> list[int]:
        """
...
def generate_mnist_concept_dataset(concept_classes: list, data_dir: Path, train: bool, subset_size: int,
